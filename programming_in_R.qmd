...
### Question 1: Using `GET` from the `httr` package

```{r}
library("httr")

news_info <- httr::GET("https://newsapi.org/v2/top-headlines?q=loveisland&apiKey=0617778f612b4946859a211593d3efda")
```
...
parsed_news_info <- fromJSON(rawToChar(news_info$content))
```
